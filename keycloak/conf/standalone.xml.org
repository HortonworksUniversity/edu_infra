        ...
        <subsystem xmlns="urn:jboss:domain:datasources:6.0">
            <datasources>
                ...
                <datasource jndi-name="java:jboss/datasources/KeycloakDS" pool-name="KeycloakDS" enabled="true" use-java-context="true" use-ccm="true">
                    <connection-url>jdbc:postgresql://${env.DB_ADDR:postgresql}:${env.DB_PORT:5432}/${env.DB_DATABASE:keycloak}${env.JDBC_PARAMS:}</connection-url>
                    ...
                    <security>
                        ...
                        <password>${env.DB_PASSWORD:BadPass%1}</password>
                    </security>
                    <validation>
